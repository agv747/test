...
function recognitionTab(ctx) {
      ...
      <div class="detection__head">
        <div class="detection__body">
          <div class="detection__name">${esc(p.label)}
            ...
            ${p.kind === 'configured' ? '<span class="pill pill--info">Server-managed SG route</span>' : simulated
  ...
  return `<div class="card">
    ...
    <p class="small mt"><a href="#/admin/ai">Configure connections, discover models and set the Singapore task default →</a></p>
    <h3 class="mt">Recognition options</h3>
